...
func ShowBeautifulHelp() {
	...
	addOption(&helpContent, "--source", "Specify source (hianime, animefire, goyabu, superflix). Default: search all sources.")
	...
	addFeature(&helpContent, "Multi-Source Support", "Stream from HiAnime, AnimeFire, Goyabu, and SuperFlix with automatic fallback.")
	...
	addExample(&helpContent, "goanime -d --source hianime \"bleach\" 10", "Download from HiAnime specifically")
