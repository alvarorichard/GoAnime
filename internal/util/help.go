...
func ShowBeautifulHelp() {
	...
	addExample(&helpContent, "goanime -dm -a \"breaking bad\"", "Download ALL seasons and episodes of a TV show")
	addExample(&helpContent, "goanime -dm -a \"dororo\"", "Download ALL episodes of a dorama/anime series")
	helpContent.WriteString("\n")
