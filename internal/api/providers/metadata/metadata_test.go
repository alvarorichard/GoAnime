...
func TestEnrichAnime_SuperFlixFallback(t *testing.T) {
	...
	searchHTML := `<html><body>
		<div class="card">
			...
			<button data-msg="Copiar Link" data-copy="https://superflixapi.cyou/serie/73223">Link</button>
		</div>
	</body></html>`
	mock.responses["GET:superflixapi.cyou/pesquisar"] = &http.Response{
		StatusCode: http.StatusOK,
	...
	mock.responses["GET:superflixapi.cyou/serie/73223"] = &http.Response{
		StatusCode: http.StatusOK,
