...
func TestEnrichAnime_SuperFlixFallback(t *testing.T) {
	...
	searchHTML := `<html><body>
		<div class="card">
			...
			<button data-msg="Copiar Link" data-copy="https://superflixapi.beer/serie/73223">Link</button>
		</div>
	</body></html>`
	mock.responses["GET:superflixapi.beer/pesquisar"] = &http.Response{
		StatusCode: http.StatusOK,
	...
	mock.responses["GET:superflixapi.beer/serie/73223"] = &http.Response{
		StatusCode: http.StatusOK,
